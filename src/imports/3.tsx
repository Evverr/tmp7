...
export default function Component() {
  return (
    <div className="relative size-full" data-name="3">
      ...
      <div className="absolute font-['Unbounded:Medium',sans-serif] h-[842px] left-0 not-italic overflow-clip top-0 w-[595px] whitespace-nowrap" data-name="A4 - 4" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(rgb(47, 218, 227) 0%, rgb(80, 251, 223) 84.135%)" }}>
      ...
      <div className="absolute font-['Unbounded:Regular',sans-serif] h-[227px] leading-[0] left-[67px] not-italic text-[#2c2c2c] text-[13px] top-[109px] tracking-[0.26px] w-[475px]">
      ...
      <div className="absolute font-['Unbounded:Regular',sans-serif] leading-[0] left-[67px] not-italic text-[#2c2c2c] text-[13px] top-[274px] tracking-[0.26px] w-[478px]">
      ...
      <div className="absolute font-['Unbounded:Regular',sans-serif] h-[274px] leading-[0] left-[67px] not-italic text-[#2c2c2c] text-[13px] top-[449px] tracking-[0.26px] w-[205px]">
        <p className="leading-[27px] mb-0">&nbsp;</p>
