export default function Component() {
  return (
    <div className="relative size-full" data-name="2">
      ...
      <p className="-translate-x-1/2 absolute font-['Unbounded',sans-serif] font-medium h-[130px] leading-[27px] left-[294.5px] not-italic text-[#00b2b7] text-[28px] text-center top-[694px] tracking-[0.56px] w-[455px]">🐾 Побежали!</p>
    </div>
  );
}
